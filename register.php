...
<div class="bbcrumb"><a href="http://digitalhumanities.org/answers/">Digital Humanities Questions &amp; Answers</a> &raquo; Register</div>

<h2 id="register" role="main">Registration</h2>


<form method="post" action="http://digitalhumanities.org/answers/register.php">

<fieldset>
<legend>Create a DHAnswers ID <span id="reg-or">or</span></legend>
...
<table width="100%">
	...
	<tr class="form-field form-non-required non-required">
		<th scope="row">
...
<fieldset><legend>Use OpenID</legend><p>(GMail, Yahoo!, or other <a href='http://openid.net/get-an-openid/'>OpenID account</a>)</p><table><tr class="form-field"><th scope="row"><label for="openid_url">OpenID</label></th><td><input value=""  name="openid_identity" id="openid_identity"  style="padding-left:20px;  background: #fff url(http://digitalhumanities.org/answers/my-plugins/openid-plus/openid.png) no-repeat center left;" type="text" /></td></tr></table></fieldset><script type='text/javascript'>var RecaptchaOptions = { theme : 'white', lang : 'en' , tabindex : 5 };</script><p class='recaptcha'>To help us avoid spam, please type the two words below.</p><script type="text/javascript" src="http://api.recaptcha.net/challenge?k=6LfBF7sSAAAAAPN47fR7HC024EyvFkLJTQhzoevT"></script>

	<noscript>
  		<iframe src="http://api.recaptcha.net/noscript?k=6LfBF7sSAAAAAPN47fR7HC024EyvFkLJTQhzoevT" height="300" width="500" frameborder="0"></iframe><br/>
	...
	<input type="submit" name="Submit" value="Register &raquo;" />
			...
			<div id="footer" role="contentinfo" class="span-24">
				<div id="lang-switch">
					...
					<form id="bb_language_switcher" style="display:inline-block;"><select  style="width:150px;" name="bb_language_switcher" onchange="location.href='/answers/register.php?bblang=' + this.options[this.selectedIndex].value;">
