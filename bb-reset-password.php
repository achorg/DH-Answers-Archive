...
<h2 role="main">Password Reset</h2>
			...
			<div id="footer" role="contentinfo" class="span-24">
				<div id="lang-switch">
					...
					<form id="bb_language_switcher" style="display:inline-block;"><select  style="width:150px;" name="bb_language_switcher" onchange="location.href='/answers/bb-reset-password.php?bblang=' + this.options[this.selectedIndex].value;">
